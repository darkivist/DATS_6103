...
bar1 = mushroom['class'].value_counts().plot(kind='bar')
plt.tight_layout()
plt.show()

#Edible vs poisonous - dataset is pretty balanced


bar2 = mushroom['odor'].value_counts().plot(kind='bar')
plt.tight_layout()
plt.show()

bar3 = mushroom['habitat'].value_counts().plot(kind='bar')
plt.tight_layout()
plt.show()

bar4 = mushroom['cap_shape'].value_counts().plot(kind='bar')
plt.tight_layout()
plt.show()

bar5 = mushroom['cap_color'].value_counts().plot(kind='bar')
plt.tight_layout()
plt.show()

bar6 = mushroom['population'].value_counts().plot(kind='bar')
plt.tight_layout()
plt.show()
...
mosaic_chart = mosaic(mushroom, ['population', 'class'])
plt.tight_layout()
plt.show()

#Population vs. class. Edibles grow in numerous and abundant patterns, but poisonous do not.

#cite https://datascience.stackexchange.com/questions/89692/plot-two-categorical-variables
cat_chart1 = sns.histplot(binwidth=0.5, x="class", hue="habitat", data=mushroom, stat="count", multiple="stack")
plt.tight_layout()
plt.show()

#Habitat vs. class - e.g. more likely to find poisonous mushrooms on a path than edible, more likely to find edible mushrooms in the woods than poisonous. Poisonous mushrooms never grow in “waste.”

cat_chart2 = sns.histplot(binwidth=1, x="class", hue="odor", data=mushroom, stat="count", multiple="stack")
plt.tight_layout()
plt.show()

#Odor vs. class. Edible mushrooms are much more likely to be odorless or smell “pleasant”, while poisonous mushrooms are likely to smell foul.

cat_chart3 = sns.histplot(binwidth=0.5, x="class", hue="gill_size", data=mushroom, stat="count", multiple="stack")
plt.tight_layout()
plt.show()

#Gill size vs. class. Edible mushrooms are more often have broad gills.

cat_chart4 = sns.histplot(binwidth=0.5, x="class", hue="stalk_surface_below_ring", data=mushroom, stat="count", multiple="stack")
plt.tight_layout()
plt.show()

#Stalk surface below ring vs. class. Edibles are likely to have smooth surfaces, poisonous are likely to be silky.

cat_chart5 = sns.histplot(binwidth=0.5, x="class", hue="stalk_shape", data=mushroom, stat="count", multiple="stack")
plt.tight_layout()
plt.show()

cat_chart6 = sns.histplot(binwidth=0.5, x="class", hue="spore_print_color", data=mushroom, stat="count", multiple="stack")
plt.tight_layout()
plt.show()

#Spore print color vs. class. If a mushroom has chocolate colored spore print, it’s likely poisonous, if it has black, it’s likely to be edible.
